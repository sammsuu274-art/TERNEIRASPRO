...
class Command(BaseCommand):
    ...
    def _gerar_eventos_terneira(self, filhote, parto, prog, banco,
        ...
        col1 = Colostragem.objects.create(
            ...
            brix=Decimal(str(round(brix_colostro, 1))) if random.random() > 0.4 else None,
            temperatura_c=Decimal(str(round(rand_decimal(37.5, 39.5, 1), 1))) if random.random() > 0.5 else None,
        ...
        for dias in marcos:
            ...
            pes = Pesagem.objects.create(
                ...
                altura_garupa_cm=Decimal(str(round(rand_decimal(65, 115, 1), 1))) if random.random() > 0.4 else None,
                perimetro_toracico_cm=Decimal(str(round(rand_decimal(60, 140, 1), 1))) if random.random() > 0.5 else None,
                ecc=Decimal(str(round(rand_decimal(2.0, 4.0, 1), 1))) if random.random() > 0.6 else None,
                responsavel=admin,
            )
            av_pes(pes)
        ...
        if idade_hoje >= 3:
            ...
            if random.random() < 0.25:
                ...
                if inicio_diag <= hoje:
                    ...
                    OcorrenciaSanitaria.objects.create(
                        ...
                        temperatura_retal=Decimal(str(round(rand_decimal(38.5, 40.5, 1), 1))),
            ...
            if idade_hoje > 30 and random.random() < 0.15:
                ...
                OcorrenciaSanitaria.objects.create(
                    ...
                    temperatura_retal=Decimal(str(round(rand_decimal(39.5, 41.2, 1), 1))),
            ...
            if tem_onfalite and idade_hoje >= 3:
                ...
                OcorrenciaSanitaria.objects.create(
                    ...
                    temperatura_retal=Decimal(str(round(rand_decimal(39.0, 40.5, 1), 1))),
